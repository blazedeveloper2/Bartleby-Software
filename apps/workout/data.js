...
export const PROGRAM = [
  ...
  {day:'thu',label:'Upper · Pull Focus',sections:[
    {tag:null,ex:[
      ...
      {n:'Single-Arm Rows',m:'Lats, Rhomboids, Rear Delts, Biceps',s:'2×F /arm',b:'Flat 0°',bc:'bench-flat'},
  ...
  {day:'fri',label:'Lower · Ham & Glute Focus',sections:[
    {tag:null,ex:[
      ...
      {n:'Bulgarian Split Squats',m:'Quads, Glutes, Adductors',s:'2×F /leg',b:'Flat 0°',bc:'bench-flat'},
      {n:'Single-leg RDLs',m:'Hamstrings, Glutes, Core',s:'2×F /leg'},
    ]},
    {tag:'Accessories',ex:[
      {n:'Seated Calf Raises',m:'Soleus, Gastrocnemius',s:'2×F'},
    ]},
    {tag:'Core',ex:[
      {n:'Weighted Sit-ups',m:'Rectus Abdominis, Hip Flexors, Obliques',s:'2×F'},
      {n:'Dead Bugs',m:'Rectus Abdominis, TVA',s:'2×F /side'},
