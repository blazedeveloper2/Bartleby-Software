...
export const FRONT_SVG = `<svg viewBox="0 0 160 340" xmlns="http://www.w3.org/2000/svg" class="m-fig" role="img" aria-label="Front view of the body">
  ${BASE}
...
export const BACK_SVG = `<svg viewBox="0 0 160 340" xmlns="http://www.w3.org/2000/svg" class="m-fig" role="img" aria-label="Back view of the body">
  ${BASE}
...
export const MUSCLE_SVG = `<figure class="m-side"><figcaption class="m-label">Front</figcaption>${FRONT_SVG}</figure>
